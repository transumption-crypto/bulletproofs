...
pub struct WeightedInnerProdArg<E: Curve = Secp256k1> where E: Curve {
...
impl<E> WeightedInnerProdArg<E> where E: Curve {
    pub fn prove(
        G: &[Point<E>],
        H: &[Point<E>],
        g: &Point<E>,
...
mod tests {
    ...
    fn test_helper(n: usize) {
        ...
        let c = super::weighted_inner_product::<Secp256k1>(&a, &b, y_scalar.clone());
    ...
    fn test_wip() {
        ...
        let a_weighted_b = weighted_inner_product::<Secp256k1>(&a, &b, y);
        assert_eq!(
            a_weighted_b,
            BigInt::from(46),
